...
VOID CSDHControllerCh0::PowerUp() {
    RETAILMSG(FALSE,(TEXT("[HSMMC0] Power Up the HSMMC Host Controller\n")));
...
BOOL CSDHControllerCh0::InitClkPwr() {
    ...
    RETAILMSG(FALSE, (TEXT("[HSMMC0] Setting registers for the USB48MHz (EXTCLK for SDCLK) : SYSCon.\n")));
...
BOOL CSDHControllerCh0::InitGPIO() {
    ...
    RETAILMSG(FALSE, (TEXT("[HSMMC0] Setting registers for the GPIO.\n")));
...
#ifdef _SRCCLK_48MHZ_
    RETAILMSG(FALSE, (TEXT("[HSMMC0] Setting registers for the USB48MHz (EXTCLK) : HSMMCCon.\n")));
