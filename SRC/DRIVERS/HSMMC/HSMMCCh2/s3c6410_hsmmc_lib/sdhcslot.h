...
// The enumeration for factors is used in card detect interrupt handler of HSMMC ch2 on SMRP6400.
...
#else
    // Prototype for the new Interrupt handler function can process factors on new card detect interrupt of HSMMC ch2 on SMDK6410.
...
#ifdef _SMDK6410_CH2_EXTCD_
    // Prototype for a new function can detect whether card is presented of HSMMC ch2 on SMRP6400.
