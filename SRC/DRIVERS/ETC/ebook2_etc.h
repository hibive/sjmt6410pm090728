...
#ifndef __EBOOK2_ETC_H__
#define __EBOOK2_ETC_H__
...
#define IOCTL_SET_POWER_GPS\
	CTL_CODE(ETC_DRIVER_DEVICE, ETC_DRIVER_FUNCTION+0x03, METHOD_NEITHER, FILE_ANY_ACCESS)
#define IOCTL_GET_POWER_GPS\
	CTL_CODE(ETC_DRIVER_DEVICE, ETC_DRIVER_FUNCTION+0x04, METHOD_NEITHER, FILE_ANY_ACCESS)
#define IOCTL_SET_KEY_HOLD\
	CTL_CODE(ETC_DRIVER_DEVICE, ETC_DRIVER_FUNCTION+0x05, METHOD_NEITHER, FILE_ANY_ACCESS)
#define IOCTL_GET_KEY_HOLD\
	CTL_CODE(ETC_DRIVER_DEVICE, ETC_DRIVER_FUNCTION+0x06, METHOD_NEITHER, FILE_ANY_ACCESS)


#endif //__EBOOK2_ETC_H__
