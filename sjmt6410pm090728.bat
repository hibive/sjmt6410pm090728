...
@REM set BSP_IROM_SDMMC_CH0_BOOT=
@REM set BSP_IROM_SDMMC_CH1_BOOT=

set WINCEREL=1

set BSP_NODISPLAY=1
set BSP_NOVIDEO=
if /i "%BSP_NODISPLAY%"=="1" set BSP_NOVIDEO=1
set BSP_NOBACKLIGHT=
if /i "%BSP_NODISPLAY%"=="1" set BSP_NOBACKLIGHT=1
set BSP_NOTOUCH=
if /i "%BSP_NODISPLAY%"=="1" set BSP_NOTOUCH=1

if /i "%BSP_NODISPLAY%"=="1" set BSP_DISPLAY_BROADSHEET=1
if /i "%BSP_DISPLAY_BROADSHEET%"=="1" set BSP_TOUCH_UART=1
...
set BSP_NOHSMMC_CH0=
@REM if /i "%BSP_IROM_SDMMC_CH0_BOOT%"=="1" set BSP_NOHSMMC_CH0=1
set BSP_NOHSMMC_CH1=
@REM if /i "%BSP_IROM_SDMMC_CH1_BOOT%"=="1" set BSP_NOHSMMC_CH1=1
...
set BSP_NOD3DM=
if /i "%BSP_DISPLAY_BROADSHEET%"=="1" set BSP_NOD3DM=1
set BSP_NOCAMERA=1
...
set BSP_NOMFC=
if /i "%BSP_DISPLAY_BROADSHEET%"=="1" set BSP_NOMFC=1
set BSP_NOJPEG=
if /i "%BSP_DISPLAY_BROADSHEET%"=="1" set BSP_NOJPEG=1
set BSP_NOOES=
if /i "%SMDK6410_X5D%"=="1" set BSP_NOOES=1
if /i "%BSP_DISPLAY_BROADSHEET%"=="1" set BSP_NOOES=1

set BSP_NOCMM=
if /i "%BSP_DISPLAY_BROADSHEET%"=="1" set BSP_NOCMM=1
set BSP_NOUAO=
if /i "%BSP_DISPLAY_BROADSHEET%"=="1" set BSP_NOUAO=1
...
if /i "%BSP_DISPLAY_BROADSHEET%"=="1" set SAMPLES_DSHOWFILTERS=
set SAMPLES_MFC=1
if /i "%BSP_DISPLAY_BROADSHEET%"=="1" set SAMPLES_MFC=
set SAMPLES_MFC_API=1
if /i "%BSP_DISPLAY_BROADSHEET%"=="1" set SAMPLES_MFC_API=
set SAMPLES_JPEG=1
if /i "%BSP_DISPLAY_BROADSHEET%"=="1" set SAMPLES_JPEG=
set SAMPLES_HYBRIDDIVX=1
if /i "%BSP_DISPLAY_BROADSHEET%"=="1" set SAMPLES_HYBRIDDIVX=
set SAMPLES_CMM=1
if /i "%BSP_DISPLAY_BROADSHEET%"=="1" set SAMPLES_CMM=
set SAMPLES_VFP_TEST=1
if /i "%BSP_DISPLAY_BROADSHEET%"=="1" set SAMPLES_VFP_TEST=
...
set APPS_EBOOK2_STARTUP=
if /i "%BSP_DISPLAY_BROADSHEET%"=="1" set APPS_EBOOK2_STARTUP=1
set APPS_EBOOK2_COMMAND=
if /i "%BSP_DISPLAY_BROADSHEET%"=="1" set APPS_EBOOK2_COMMAND=1

if not "%BSP_DISPLAY_BROADSHEET%"=="1" (
	set SYSGEN_D3DM=1
	set SYSGEN_DDRAW=1
