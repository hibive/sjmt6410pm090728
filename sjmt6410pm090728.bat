...
@REM OMNIBOOK_VER 3 or 4
set OMNIBOOK_VER=4

set OMNIBOOK_VER_DEMO=

set MODEL_OMNIBOOK_GW610=
set MODEL_BOOKCUBE_B612=1
...
set BSP_TOUCH_UART=
if /i "%OMNIBOOK_VER_DEMO%"=="1" set BSP_TOUCH_UART=1
...
if "%OMNIBOOK_VER_DEMO%"=="1" (
	set SYSGEN_IESAMPLE=1
	set SYSGEN_TVLENS_ALL=1
