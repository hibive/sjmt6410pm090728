...
#ifdef SIMON_CHANGED
extern "C" MP4FileHandle MP4ReadWchar(const wchar_t* fileName, u_int32_t verbosity)
{
    MP4File* pFile = NULL;
    __try {
        pFile = new MP4File(verbosity);
...
//            delete e;
        ...
        if (MP4_IS_VALID_TRACK_ID(trackId)) {
          ...
          uint32_t bufsize;
          uint8_t type;
          // for mpeg4 video tracks, __try to look for the VOSH header,
          // which has this info.
    ...
    MP4FileHandle hFile, MP4TrackId trackId)
{
    ...
    __except (EXCEPTION_EXECUTE_HANDLER) {
//    printf("\nMP4GetTrackMediaDataName EXCEPTION....");
    }
/*
        __try {
            return ((MP4File*)hFile)->GetTrackMediaDataName(trackId);
