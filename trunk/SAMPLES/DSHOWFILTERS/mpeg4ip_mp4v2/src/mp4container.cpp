    ...
    MP4Property** ppProperty, u_int32_t* pIndex)
{
    if (!FindProperty(name, ppProperty, pIndex)) {
        printf("\n[%s]  %s", "MP4Container::FindIntegerProperty", "no such property");
    ...
    case Integer64Property:
        break;
    default:
        printf("\n[%s]  %s", "MP4Container::FindIntegerProperty", "type mismatch");
...
{
    if (!FindProperty(name, ppProperty, pIndex)) {
        printf("\n[%s]  %s", "MP4Container::FindFloatProperty", "no such property");
        throw new MP4Error("no such property",
             "MP4Container::FindFloatProperty");
    }
    if ((*ppProperty)->GetType() != Float32Property) {
        printf("\n[%s]  %s", "MP4Container::FindFloatProperty", "type mismatch");
        throw new MP4Error("type mismatch", 
            "MP4Container::FindFloatProperty");
    }
}
...
{
    if (!FindProperty(name, ppProperty, pIndex)) {
        printf("\n[%s]  %s", "MP4Container::FindStringProperty", "no such property");
        throw new MP4Error("no such property",
            "MP4Container::FindStringProperty");
    }
    if ((*ppProperty)->GetType() != StringProperty) {
        printf("\n[%s]  %s", "MP4Container::FindStringProperty", "type mismatch");
        throw new MP4Error("type mismatch", 
            "MP4Container::FindStringProperty");
    }
}
...
{
    if (!FindProperty(name, ppProperty, pIndex)) {
        printf("\n[%s]  %s", "MP4Container::FindBytesProperty", "no such property");
        throw new MP4Error("no such property",
            "MP4Container::FindBytesProperty");
    }
    if ((*ppProperty)->GetType() != BytesProperty) {
        printf("\n[%s]  %s", "MP4Container::FindBytesProperty", "type mismatch");
        throw new MP4Error("type mismatch",
            "MP4Container::FindBytesProperty");
    }
}
