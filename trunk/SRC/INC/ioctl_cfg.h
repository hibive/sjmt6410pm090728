...
//
#ifdef	EBOOK2_VER
#define IOCTL_PLATFORM_TYPE	(L"EBOOK2 S3C6410 WINCE600")
#if (EBOOK2_VER == 3)
#define IOCTL_PLATFORM_OEM	(L"EBOOK2 VER0.3 SEOJEON MEDIATECH")
#elif (EBOOK2_VER == 2)
#define IOCTL_PLATFORM_OEM	(L"EBOOK2 VER0.2 SEOJEON MEDIATECH")
#endif
#else	EBOOK2_VER
...
#ifdef	EBOOK2_VER
#define IOCTL_HAL_EBOOK2_SHUTDOWN           CTL_CODE(FILE_DEVICE_UNKNOWN, 2200, METHOD_BUFFERED, FILE_ANY_ACCESS)
#endif	EBOOK2_VER
