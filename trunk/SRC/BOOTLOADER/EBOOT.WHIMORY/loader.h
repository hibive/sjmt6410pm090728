...
#define STEPLDR_RAM_IMAGE_SIZE		(0x0003F000) //(IMAGE_STEPLOADER_SIZE)//only use 0x00001000
...
#define BOOT_WRITE_EPSON	0x10000000
#define BOOT_WRITE_BLOCK0	0x20000000
#define BOOT_WRITE_EBOOT	0x40000000
#define BOOT_WRITE_NK		0x80000000
#define BOOT_WRITE_MASK(dw)	(0xF0000000 & (dw))
#endif	OMNIBOOK_VER
